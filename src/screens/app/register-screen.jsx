...
export const RegisterScreen = () => {
    ...
    const validateForm = () => {
        ...
        if (!formData.correo) {
            ...
            newErrors.correo = 'Debe usar un correo institucional (@correounivalle.edu.co)';
            valid = false;
        }
                ...
                <div className="grid grid-nogutter max-w-screen-lg mx-auto px-4">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-column gap-4">
                            ...
                            <div className="field mb-3">
                                <label htmlFor="codigo" className="block mb-2 font-medium">Código *</label>
                                <InputText
                                    id="codigo"
                                    name="codigo"
                                    ...
                                    className={classNames('w-full', { 'p-invalid': isFormFieldValid('codigo') })}
                                    keyfilter="num"
                                    maxLength="9"
                            ...
                            <div className="field mb-3">
                                ...
                                <InputText
                                    ...
                                    className={classNames('w-full', { 'p-invalid': isFormFieldValid('nombre') })}
                                    aria-describedby="nombre-error"
                                />
                            ...
                            <div className="field mb-3">
                                ...
                                <InputText
                                    ...
                                    className={classNames('w-full', { 'p-invalid': isFormFieldValid('apellido') })}
                                />
                                {getFormErrorMessage('apellido')}
                            </div>

                            <div className="field mb-3">
                                <label htmlFor="correo" className="block mb-2 font-medium">Correo Institucional *</label>
                                <InputText
                                    id="correo"
                                    name="correo"
                                    ...
                                    className={classNames('w-full', { 'p-invalid': isFormFieldValid('correo') })}
                                    aria-describedby="nombre-error"
                                    keyfilter="email"
                                />
                            ...
                            <div className="field mb-3">
                                ...
                                <InputText
                                    ...
                                    className={classNames('w-full', { 'p-invalid': isFormFieldValid('telefono') })}
                                    keyfilter="num"
                                    maxLength="10"
                                />
